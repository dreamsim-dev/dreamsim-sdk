...
public class Advertisement : MonoBehaviour
{
    ...
    public async UniTask InitAsync(DreamsimSettings.AdvertisementSettings settings)
    {
        await InitLevelPlayAsync(settings.LevelPlay);
    }

    private async UniTask InitLevelPlayAsync(DreamsimSettings.AdvertisementSettings.LevelPlaySettings settings)
    {
