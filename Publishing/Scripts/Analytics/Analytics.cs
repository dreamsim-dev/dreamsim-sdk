...
{
public class Analytics : MonoBehaviour, IAnalyticsLogger
{
    [SerializeField]
    ...
    public async UniTask InitAsync(DreamsimSettings.AnalyticsSettings settings, DreamsimSettings.GDPRSettings gdprSettings)
    {
    ...
    {
        // To set device token into SDKs (i.e. Adjust)
    }
